...
<h2 id="replace"><a href="#replace">Replace a (>1 Character) String inside another String</a></h2>
<table>
<tr>
<th>Method</th>
<th>Not found</th>
...
<h2 id="strtr"><a href="#strtr">Replace a Character inside a String</a></h2>
<table>
<tr>
<th>Method</th>
<th>Not found</th>
...
<p>My conclusion: Since PHP 7.0 <code>strtr()</code> can sometimes beat <code>str_replace()</code>.</p>
...
<p>My conclusion:
Don't use <code>split()</code>. It got deprecated in PHP 5.3 and removed from PHP 7.0.</p>
...
<p>My conclusion:
<code>count()</code> could have been horribly slow in PHP 5 and below when copy-on-write accidentally kicked in. Always precalculate it, if possible.</p>
